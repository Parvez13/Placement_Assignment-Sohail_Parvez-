import sys
from product_detection.configuration.s3_operations import S3Operation
from product_detection.entity.artifacts_entity import (
    ModelPusherArtifacts,
    ModelTrainerArtifact
)
from product_detection.entity.config_entity import ModelPusherConfig
